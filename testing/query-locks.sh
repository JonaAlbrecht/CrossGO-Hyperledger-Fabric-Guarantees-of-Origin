...
echo "Querying conversion locks..."
peer chaincode query -C electricity-de -n golifecycle -c '{"function":"conversion:ListConversionLocks","Args":["100",""]}'
