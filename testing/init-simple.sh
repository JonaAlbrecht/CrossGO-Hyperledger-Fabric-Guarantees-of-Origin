#!/bin/bash
# Simplified initialization - just bootstrap roles and create GOs
set -e
...
echo "========================================="
echo "SIMPLIFIED LEDGER INITIALIZATION"
echo "========================================="
echo ""

# ELECTRICITY CHANNEL
echo ">>> Bootstrapping eissuer as issuer on electricity-de..."
set_peer_env eissuer 7051
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer1.go-platform.com \
...
# HYDROGEN CHANNEL
echo ""
echo ">>> Bootstrapping hissuer as issuer on hydrogen-de..."
...
echo "Roles registered on both channels"
echo "========================================="
