...
type ElectricityGO struct {
	...
	CountryOfOrigin      string `json:"CountryOfOrigin,omitempty"`      // ADR-012: ISO 3166-1 alpha-2 (e.g. "DE", "NL")
	GridConnectionPoint  string `json:"GridConnectionPoint,omitempty"`  // ADR-012: EIC code of the grid connection
	SupportScheme        string `json:"SupportScheme,omitempty"`        // ADR-012: "none", "FIT", "FIP", "quota" etc.
	EnergySource         string `json:"EnergySource,omitempty"`         // ADR-012: EN 16325 source code (e.g. "F01010100" = solar)
